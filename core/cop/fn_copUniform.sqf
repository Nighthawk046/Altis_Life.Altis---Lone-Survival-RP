...
*/
	...
	if (__GETC__(life_coplevel) > 0)  then {
		player setObjectTextureGlobal [0, "textures\uniforms\Officer.jpg"]; // this is for all cops whitelisted or public.
	};
	...
	if ((uniform player) == "U_Rangemaster")  then {
		player setObjectTextureGlobal [0, "textures\uniforms\Officer.jpg"];
	};
