...
switch (_shop) do
{
	...
	case "reb_car":
	{
		...
		[
			...
			["I_Heli_light_03_F",1500000],
			["O_Heli_Attack_02_F",2000000]
		];
	...
	case "cop_air":
	{
		...
		if(__GETC__(life_coplevel) >= 6) then
		{
			...
			_return pushBack
			["B_Heli_Transport_03_black_F",200000];
			_return pushBack
			["O_Heli_Transport_04_covered_black_F",200000];
			_return pushBack
			["B_Heli_Attack_01_F",1500000];
		};
	};
